...
CREATE TABLE IF NOT EXISTS events (
  ...
  CONSTRAINT events_creator_fk FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS event_guests (
  ...
  CONSTRAINT event_guests_event_fk FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
  CONSTRAINT event_guests_list_fk FOREIGN KEY (guest_list_id) REFERENCES event_guest_lists(id) ON DELETE SET NULL,
  CONSTRAINT event_guests_admitted_user_fk FOREIGN KEY (admitted_by) REFERENCES users(id) ON DELETE SET NULL,
  CONSTRAINT event_guests_creator_fk FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE RESTRICT
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS event_access_log (
  ...
  CONSTRAINT event_access_event_fk FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE SET NULL,
  CONSTRAINT event_access_guest_fk FOREIGN KEY (guest_id) REFERENCES event_guests(id) ON DELETE SET NULL,
  CONSTRAINT event_access_scanner_fk FOREIGN KEY (scanned_by) REFERENCES users(id) ON DELETE RESTRICT
) ENGINE=InnoDB;
...
BEGIN
  ...
  -- Sublistas de invitados por evento (promotores, cortesías o grupos).
